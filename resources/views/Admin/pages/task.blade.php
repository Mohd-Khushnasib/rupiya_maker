            ...
            <div class="modal-body">
                <div class="col-md-12">
                    <form id="add_form" method="post" class="mail-compose form-horizontal" action="javascript:void(0);">
                        ...
                        <p>
                            <select name="task_type[]" data-placeholder="Type Task" class="form-control AddChosen chosen"
                                tabindex="6">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="controls">
                                    <select name="lead_type" id="lead_type" class="form-control lead_type"
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="controls">
                                    <select name="lead_id" id="customer_name" class="form-control customer_name"
                                        data-placeholder="Choose Here" tabindex="1">
                        ...
                        <p>
                            <select name="assign[]" data-placeholder="Assign" class="form-control AddChosen chosen"
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    editButton.addEventListener("click", function() {
        ...
        $(".chosen").removeAttr("disabled").trigger("chosen:updated"); // this chosen active edit task case
        // $(".EditChoosen").removeAttr("disabled").trigger("EditChoosen:updated");
        $(".AddChosen").removeAttr("disabled", true).trigger("AddChosen:updated"); // this chosen disabled add task case

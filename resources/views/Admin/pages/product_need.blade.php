...
<div class="container" id="main-container">
    ...
    <div id="main-content">
        <div class="row">
            <div class="col-sm-12">
                <button id="AddProductNeedModal" class="btn btn-primary">
                    <i class="fa fa-plus"></i> Product Need
                </button>
            </div>

            <div class="col-sm-12" style="margin-top: 20px;">
                <h5>All Product Need List</h5>
            </div>
                            ...
                            <tr class="table-flag-blue">
                                ...
                                <td>
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-primary edit small-btn"
                                        data-product_need="{{$item->product_need}}" data-id="{{ $item->id }}">
...
<!-- Add Modal  -->
<div id="AddProductNeed" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title" style="color: black;" id="modalTitle">Add Product Need</h4>
            </div>
            <div class="modal-body">
                <form id="add_form" action="javascript:void(0);" enctype="multipart/form-data" method="post">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <label for="product_name">Product Need</label>
                            <input type="text" name="product_need" id="product_need" placeholder="Product Need"
                                class="form-control">
                        </div>
                        <div class="col-sm-12 ">
...
<div id="deletemodal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title" style="color: black;" id="exampleModalLabel">Delete Product Need</h4>
            </div>
            <!-- Modal Body -->
            <div class="modal-body">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" style="color: black;" id="editModalLabel">Edit Product Need</h4>
            </div>
            <!-- Modal Body -->
            <div class="modal-body">
                <form id="edit_form" action="javascript:void(0);" enctype="multipart/form-data" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <label for="product_need">Product Need</label>
                            <input type="text" name="product_need" id="edit_product_need" class="form-control">
                        </div>
                        <div class="col-sm-12">
...
$("#add_form").submit(function(e) {
    ...
    if (product_need) {} else {
        alertify.set('notifier', 'position', 'top-right');
        alertify.error('Product Need required');
        return;
    }
    e.preventDefault();
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data.success == 'success') {
                ...
                $("#AddProductNeed").modal("hide");
                swal("Product Need Added Successfully", "", "success");
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data.success == 'success') {
                ...
                $("#delete_form")[0].reset();
                swal("Product Need Delete Successfully! ", "", "success");
                window.location.reload();
            } else {
                swal('Product Need Not Added', '', 'error');
                $(".btn_delete").prop("disabled", false);
            }
        },
...
$(document).on('click', '.edit', function() {
    var id = $(this).data('id');
    var product_need = $(this).data('product_need');
    $("#edit_id").val(id);
    $("#edit_product_need").val(product_need);
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data.success == 'success') {
                ...
                swal("Product Need Updated Successfull", "", "success");
                window.location.reload();
            } else {
                swal("Product Need Not Update!", "", "error");
                $(".btn_update").prop('disabled', false);
            }
        },
...
$('.StatusSwitch').change(function() {
    ...
    var tableName = "tbl_product_need";
    swal({
        title: "Are you sure?",
...
$(document).ready(function() {
    $('#AddProductNeedModal').on('click', function() {
        $('#AddProductNeed').modal('show');
    });
    ...
    $('#AddProductNeed').on('shown.bs.modal', function() {
        console.log('Modal is now fully visible!');
    });

    $('#AddProductNeed').on('hidden.bs.modal', function() {

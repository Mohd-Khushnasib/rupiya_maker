                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="form-group">
                            ...
                            <select name="marital_status" class="form-control" id="statusSelect">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="date" name="spouse_dob" value="{{$leads->spouse_dob ?? ''}}"
                                class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="form-group">
                            <label class="control-label text-light">DOJ IN CURRENT
                                COMPANY</label>
                            <input type="text" name="current_company" value="{{$leads->current_company ?? ''}}"
                                class="form-control">
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
        ...
        success: function(data) {
            ...
            if (data.success == 'success') {
                ...
                swal("Form Save Successful", "", "success").then(() => {
                    var thankYouPage = window.open("{{url('/thankyou')}}", "_blank"); tab
                    setTimeout(() => {

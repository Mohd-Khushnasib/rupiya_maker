...
function generatePaginationLinks(currentPage, lastPage, searchKeyword, lead_status, fromDate, toDate) {
    ...
    if (currentPage > 3) {
        pagination.append(`
            <li class="page-item">
                <a class="page-link" href="javascript:void(0);" onclick="view_enquiry_api(1, '${searchKeyword}', '${lead_status}', '${fromDate}', '${toDate}')">1</a>
            </li>
            <li class="page-item">
                <a class="page-link" href="javascript:void(0);" onclick="view_enquiry_api(2, '${searchKeyword}', '${lead_status}', '${fromDate}', '${toDate}')">2</a>
            </li>
    ...
    for (let i = Math.max(1, currentPage - 2); i <= Math.min(lastPage, currentPage + 2); i++) {
        pagination.append(`
            <li class="page-item ${i === currentPage ? 'active' : ''}">
                <a class="page-link" href="javascript:void(0);" onclick="view_enquiry_api(${i}, '${searchKeyword}', '${lead_status}', '${fromDate}', '${toDate}')">${i}</a>
            </li>
        `);
    }
    ...
    if (currentPage < lastPage - 2) {
        pagination.append(`
            <li class="page-item disabled"><a class="page-link">...</a></li>
            <li class="page-item">
                <a class="page-link" href="javascript:void(0);" onclick="view_enquiry_api(${lastPage - 1}, '${searchKeyword}', '${lead_status}', '${fromDate}', '${toDate}')">${lastPage - 1}</a>
            </li>
            <li class="page-item">
                <a class="page-link" href="javascript:void(0);" onclick="view_enquiry_api(${lastPage}, '${searchKeyword}', '${lead_status}', '${fromDate}', '${toDate}')">${lastPage}</a>
            </li>
        `);
    }
}

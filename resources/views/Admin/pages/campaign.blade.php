...
<div class="container" id="main-container">
    ...
    <div id="main-content">
        ...
        <div class="row">
            <div class="col-sm-12">
                <button id="AddCampaignModal" class="btn btn-primary">
                            ...
                            <tr class="table-flag-blue">
                                ...
                                <td>
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-primary edit small-btn"
                                        data-campaign_name="{{$item->campaign_name}}" data-id="{{ $item->id }}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" style="color: black;" id="modalTitle">Add Campaign</h4>
            </div>
            <div class="modal-body">
                <form id="add_form" action="javascript:void(0);" enctype="multipart/form-data" method="post">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <label for="product_name">Campaign Name</label>
...
<div id="deletemodal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title" style="color: black;" id="exampleModalLabel">Delete Campaign</h4>
            </div>
            <!-- Modal Body -->
            <div class="modal-body">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" style="color: black;" id="editModalLabel">Edit Campaign Name</h4>
            </div>
            <!-- Modal Body -->
            <div class="modal-body">
                <form id="edit_form" action="javascript:void(0);" enctype="multipart/form-data" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            ...
                            <input type="text" name="campaign_name" id="edit_campaign_name" class="form-control">
                        </div>
                        <div class="col-sm-12">
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data.success == 'success') {
                ...
                swal("Campaign Name Added Successfully", "", "success");
                window.location.reload();
            } else {
                $(".btn_submit").prop("disabled", false);
                swal("Campaign Name Not Added", "", "error");
            }
        },
        error: function(err) {}
    });
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data.success == 'success') {
                ...
                $("#delete_form")[0].reset();
                swal("Campaign Name Delete Successfully! ", "", "success");
                window.location.reload();
            } else {
                swal('Campaign Name Not Added', '', 'error');
                $(".btn_delete").prop("disabled", false);
...
$(document).on('click', '.edit', function() {
    ...
    $("#edit_id").val(id);
    $("#edit_campaign_name").val(campaign_name);
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data.success == 'success') {
                ...
                swal("Campaign Name Updated Successfull", "", "success");
                window.location.reload();
            } else {
                swal("Campaign Name Not Update!", "", "error");
                $(".btn_update").prop('disabled', false);
            }
        },
...
$(document).ready(function() {
    $('#AddCampaignModal').on('click', function() {
    ...
    $('#AddCampaign').on('shown.bs.modal', function() {
        console.log('Modal is now fully visible!');
    });

    $('#AddCampaign').on('hidden.bs.modal', function() {

...
<div class="container" id="main-container">
    ...
    <div id="main-content">
        ...
        <div class="row">
            <div class="col-sm-12">
                <button id="AddChannelNameModal" class="btn btn-primary">
                    <i class="fa fa-plus"></i> Channel Name
                </button>
            </div>

            <div class="col-sm-12" style="margin-top: 20px;">
                <h5>All Channel Name List</h5>
            </div>
                            ...
                            <tr class="table-flag-blue">
                                ...
                                <td>
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-primary edit small-btn"
                                        data-channel_name="{{$item->channel_name}}" data-id="{{ $item->id }}">
...
<!-- Add Modal  -->
<div id="AddChannelName" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title" style="color: black;" id="modalTitle">Add Channel Name</h4>
            </div>
...
<div id="deletemodal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title" style="color: black;" id="exampleModalLabel">Delete Channel</h4>
            </div>
            <!-- Modal Body -->
            <div class="modal-body">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" style="color: black;" id="editModalLabel">Edit Channel Name</h4>
            </div>
            <!-- Modal Body -->
            <div class="modal-body">
...
$("#add_form").submit(function(e) {
    ...
    if (channel_name) {} else {
        ...
        alertify.error('Channel Name required');
        return;
    }
    e.preventDefault();
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data.success == 'success') {
                ...
                $("#AddChannelName").modal("hide");
                swal("Channel Name Added Successfully", "", "success");

                window.location.reload();
            } else {
                $(".btn_submit").prop("disabled", false);
                swal("Channel Name Not Added", "", "error");
            }
        },
        error: function(err) {}
    });
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data.success == 'success') {
                ...
                $("#delete_form")[0].reset();
                swal("Channel Name Delete Successfully! ", "", "success");
                window.location.reload();
            } else {
                swal('Channel Name Not Added', '', 'error');
                $(".btn_delete").prop("disabled", false);
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data.success == 'success') {
                ...
                swal("Channel Name Updated Successfull", "", "success");
                window.location.reload();
            } else {
                swal("Channel Name Not Update!", "", "error");
                $(".btn_update").prop('disabled', false);
            }
        },
...
$('.StatusSwitch').change(function() {
    ...
    var tableName = "tbl_channel_name";
    swal({
        title: "Are you sure?",
...
$(document).ready(function() {
    $('#AddChannelNameModal').on('click', function() {
        $('#AddChannelName').modal('show');
    });
    ...
    $('#AddChannelName').on('shown.bs.modal', function() {
        console.log('Modal is now fully visible!');
    });

    $('#AddChannelName').on('hidden.bs.modal', function() {

...
<div class="container" id="main-container">
    ...
    <div id="main-content">
        ...
        <div class="row">
            <div class="col-sm-12">
                <button id="AddCaseTypeModal" class="btn btn-primary">
                    <i class="fa fa-plus"></i> CaseType
                </button>
            </div>

            <div class="col-sm-12" style="margin-top: 20px;">
                <h5>All CaseType List</h5>
            </div>
                            ...
                            <tr class="table-flag-blue">
                                ...
                                <td>
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-primary edit small-btn"
                                        data-casetype="{{$item->casetype}}" data-id="{{ $item->id }}">
...
<!-- Add Modal  -->
<div id="AddCaseType" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title" style="color: black;" id="modalTitle">Add Case Type</h4>
            </div>
            <div class="modal-body">
                <form id="add_form" action="javascript:void(0);" enctype="multipart/form-data" method="post">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <label for="product_name">Case Type</label>
                            <input type="text" name="casetype" id="casetype" placeholder="Case Type"
                                class="form-control">
                        </div>
                        <div class="col-sm-12 ">
...
<div id="deletemodal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title" style="color: black;" id="exampleModalLabel">Delete Case Type</h4>
            </div>
            <!-- Modal Body -->
            <div class="modal-body">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" style="color: black;" id="editModalLabel">Edit Case Type</h4>
            </div>
            <!-- Modal Body -->
            <div class="modal-body">
                <form id="edit_form" action="javascript:void(0);" enctype="multipart/form-data" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            ...
                            <input type="text" name="casetype" id="edit_casetype" class="form-control">
                        </div>
                        <div class="col-sm-12">
...
$("#add_form").submit(function(e) {
    ...
    if (casetype) {} else {
        ...
        alertify.error('Case Type required');
        return;
    }
    e.preventDefault();
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data.success == 'success') {
                ...
                swal("Case Type Added Successfully", "", "success");
                window.location.reload();
            } else {
                $(".btn_submit").prop("disabled", false);
                swal("Case Type Name Not Added", "", "error");
            }
        },
        error: function(err) {}
    });
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data.success == 'success') {
                ...
                $("#delete_form")[0].reset();
                swal("Case Type Delete Successfully! ", "", "success");
                window.location.reload();
            } else {
                swal('Case Type Not Added', '', 'error');
                $(".btn_delete").prop("disabled", false);
            }
        },
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data.success == 'success') {
                ...
                swal("Case Type Updated Successfull", "", "success");
                window.location.reload();
            } else {
                swal("Case Type Not Update!", "", "error");
                $(".btn_update").prop('disabled', false);
            }
        },
...
$(document).ready(function() {
    $('#AddCaseTypeModal').on('click', function() {
    ...
    $('#AddCaseType').on('shown.bs.modal', function() {
